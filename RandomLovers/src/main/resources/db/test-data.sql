...
(1, 'Pineapple Pizza', 'Pizza with pineapple', 33, 'Pizza without pineapple', 33, 66, 'resources/images/pineapple-pizza.jpg', 'Serious talk. Pineapple on pizza?'),
(2, 'Socks with Shoes', 'Sock Sock. Shoe Shoe', 34, 'Sock Shoe. Sock Shoe', 34, 68, 'resources/images/sock-shoe.jpg', 'You´re getting ready in the morning, in which order do you put your socks and shoes?'),
(3, 'Cereals and Milk', 'Cereals first', 33, 'Milk first', 33, 66, 'resources/images/cereals-milk.jpg', 'Cereals or milk, which goes first in the bowl?'),
(4, 'Family Tree', 'Siblings', 33, 'Not Siblings', 33, 66, 'resources/images/siblings.jpg', 'Are these two random people related?'),
(5, 'Carneiro', 'Cordeiro', 33, 'Caseiro', 33, 66, 'resources/images/carneiro.jpg', 'Description'),
(6, 'Who came first', 'Chicken', 33, 'Egg', 33, 66, 'resources/images/chicken-egg.jpg', 'Whose '),
...
(2, 10, 3, 7, 1,2,'Sock shoe, sock shoe is definitely the better way to do it. Much more effective.'),
(3, 10, 3, 7, 2,4,'OMG!! Such cute twins!! Can´t believe the similarities!!'),
(4, 10, 3, 7, 3,5,'Caseiro! No doubts!' ),
(5, 10, 3, 7, 4,3,'Obviously milk!!! If you put cereals first you are a cereal killer!! >:D' ),
...
(10, 10, 3, 7, 4,15,'I just love Emacs!!!! Can´t imagine my life without it!!!! #Emacs4Life #DadyStallman');
